...
class ExpeditionsCard(PlayingCard):
    """Implements a Expeditions card.  By default there are five suits; each
...
def str_to_card(card_str):
    ...
    return ExpeditionsCard(rank, suit)
